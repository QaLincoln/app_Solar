...
${IMG_REFRIGE}           xpath=(//android.view.ViewGroup[@resource-id="test:id/carousel-test:id/page-Home-item-active"])[1]
${IMG_REFRI_CATEG}       xpath=(//android.view.ViewGroup[@resource-id="test:id/carousel-test:id/page-Home-item-active"])[1]
${verTodos_recomend}     xpath=(//android.widget.TextView[@text="Ver todos"])[2]
${RC_BT_MOSTRAR_MAIS}    xpath=//android.widget.TextView[@text="󱦰"]
${MC_BT_MOSTRAR_MAIS}    xpath=(//android.view.ViewGroup[@resource-id="test:id/carousel-test:id/page-Home-item"])[5]
...
E o usuario deve clicar no botão/texto "ver todos" categorias
    ...
    Wait Until Element Is Visible      xpath=//android.widget.TextView[@text="󰅁"]
    Click Element                      xpath=//android.widget.TextView[@text="󰅁"]
    Sleep    2 

E o usuario deve clicar no botão seta "mostar mais" categorias
    Sleep    2 
   
    Swipe    ${970}    ${1168}    ${33}    ${1160}    1000        #Deslizar para direita

    Wait Until Page Contains Element    ${CT_BT_MOSTRAR_MAIS}
...
Então será direcionando a tela da categoria clicada 
    ...
    Click Element    ${IMG_REFRI_CATEG}
    Wait Until Page Contains     Refrigerantes
    Page Should Contain Text     Refrigerantes
    Sleep    2
...
E o usuario deve clicar no botão/texto ver todos marcas
    Sleep    2
    Swipe    ${495}    ${1498}    ${516}    ${519}    1000         #Deslizar para baixo
...
E o usuario deve clicar no botão seta "mostar mais" marcas
    ...
    Sleep    2
    Swipe    ${929}    ${886}    ${65}    ${872}          #Deslizar para dreita
        
    Click Element     xpath=(//android.view.ViewGroup[@resource-id="test:id/carousel-test:id/page-Home-item"])[7]
...
E o usuario deve clicar na primeira imagem do segundo carrossel 
    Sleep    2
    Swipe    ${492}    ${1671}    ${484}    ${356}    #Deslizar para baixo
     ${c2} =    Set Variable     android=new UiSelector().resourceId("test:id/image-carousel-banners-test:id/page-Home").instance(0)    ###Clica na primeira imagem do carrossel
    Wait Until Element Is Visible    ${c2}
    Click Element    ${c2}
    Sleep    2     
Então será direcionando a tela do segundo carrossel 
    Sleep    2
    ${c2} =    Set Variable     android=new UiSelector().resourceId("test:id/header-test:id/page-Brand-title")    
    Page Should Contain Element    ${c2}