...
Então sera direcionado a tela home   
    Sleep    2
    Wait Until Page Contains            Buscar no SOLAR +
    Wait Until Page Contains Element    id=test:id/input-app-header    ##Buscar no SOLAR +